...
foo.instructions = [
	...
	{"@finishMission": 				[{"gotoif":["*.funds == 0", "@abortProcess"]}, "goToMissionsTab", "clickOnTransferMoneyFinishButton", {"wait": {"_forTheSignal": "waitForSubmitButton"}}, "confirmMissionCompleteButton", "sendMoneyToBTCWallet", {"gotoif": ["true", "@init"]}]},
