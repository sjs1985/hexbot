...
foo.instructions = [
	...
	{"@uploadSoftware": 			["goToOwnSoftwareArea", "runUploadSoftware", "isSoftwareAlreadyThere", {"gotoif":["*.$", "@intallSoftware"]}, "isThereMessageError", {"gotoif":["*.$", "@goToTarget"]}, {"wait": "_forPageToReload"}]},
	{"@cleanMyUploadClues": 		["goToTargetLogs", "cleanMyIpClues", "isThereMessageError", {"gotoif":["*.$", "@intallSoftware"]}, {"wait": "_forPageToReload"}]},
