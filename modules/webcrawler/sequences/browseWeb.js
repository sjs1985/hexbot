...
foo.instructions = [
	...
	{"@cleanMyUploadClues": 		["goToTargetLogs", "registerUploaded", "isSkipHideAfterUploadEnabled", {"gotoif":["*.$", "@installSoftware"]}, "isThereLogs", {"gotoif": ["!*.$", "@installSoftware"]}, "cleanMyIpClues", "submitLogs", "isThereMessageError", {"gotoif":["*.$", "@installSoftware"]}, {"wait": {"_forTheSignal": "checkProgressBar"}}]},
