var views = {
	appendControlPanel: function(){
		...
		divMain.innerHTML =
			...
			'<input id="' + FIELD_SOFTWARE_TO_INSTALL + '" class="controls fieldsContent" type="text" style="vertical-align: top; margin-left: 10px; margin-right: 10px;"> software on these <input id="' + FIELD_IPS_INSTALL_TARGETS + '" class="controls fieldsContent" type="text" style="vertical-align: initial; margin-left: 10px; margin-right: 10px;"> IPs. Don\'t wait more than <input id="' + SET_UPLOAD_TIME_LIMIT + '" class="controls fieldsContent" type="text" style="vertical-align: initial; margin-left: 10px; margin-right: 10px; width:7%">s<br>' +
